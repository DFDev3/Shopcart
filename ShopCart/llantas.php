...
<head>
    ...
    <link rel="stylesheet" href="../Styles/llantas.css">
...
<div class="product-catalog">
    <div class="product-row">
        <div class="product">
            <img src="../Media/img/0041.png" alt="Producto 1">
        ...
        <div class="product">
            <img src="../Media/img/0042.png" alt="Producto 2">
            <div class="product-info">
                <h3>Producto 2</h3>
                <p>Descripción del producto</p>
        ...
        <div class="product">
            <img src="../Media/img/0043.png" alt="Producto 3">
            <div class="product-info">
                <h3>Producto 3</h3>
                <p>Descripción del producto</p>
        ...
        <div class="product">
            <img src="../Media/img/0044.png" alt="Producto 4">
            <div class="product-info">
                <h3>Producto 4</h3>
                <p>Descripción del producto</p>
    ...
    <div class="product-row">
        <div class="product">
            <img src="../Media/img/0045.png" alt="Producto 5">
            <div class="product-info">
                <h3>Producto 5</h3>
                <p>Descripción del producto</p>
